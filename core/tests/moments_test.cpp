...
TEST_CASE("Moments", "[moments]") {
    ...
    REQUIRE(moments.U.n_rows == n_nodes);
    REQUIRE(moments.U.n_cols == n_time_steps);
    REQUIRE(moments.U.n_slices == n_features);
    
    REQUIRE(moments.w_prec.n_rows == n_nodes);
